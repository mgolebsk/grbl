...
ISR(TIMER1_COMPA_vect)
{
  ...
  TCCR2B = (1<<CS01); // Begin Timer2. Full speed, 1/8 prescaler
...
void stepper_init()
{
  ...
  TIMSK2 |= (1<<TOIE0); // Enable Timer2 overflow interrupt
  #ifdef STEP_PULSE_DELAY
    TIMSK2 |= (1<<OCIE0A); // Enable Timer2 Compare Match A interrupt
  #endif
}
